...
/**\mainpage Object-oriented Input System 2
 *
 * Welcome to the documentation of OIS. 
 *
 *
 * This website contains the documentation of the public API exposed by OIS2.
 *
 * As the name of the library suggest, this is 100% Object-oriented.
 * Every C++ classes from the library is located inside the OIS2 namespace.
 *
 * This project is licensed under the terms of the <a href="https://opensource.org/licenses/Zlib">zlib/libpng licence</a>
 *
 */

#ifndef OIS2_OISALL_H
#define OIS2_OISALL_H

#include "OIS2Prereqs.h"
